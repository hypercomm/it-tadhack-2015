...
/**
*   Message type creted for tadHack demonstration 
*   Create a MIDI message
*
**/
MessageFactory.createMIDIMessage =  function(from, to, chechsum, message, contextId) {
    var midibody = new Object();
    midibody.chechsum = chechsum;
    midibody.message = message;
    midibody.contextId = contextId;
    var crudMessage = new Message(from,to,midibody, MessageType.MIDI_MESSAGE, "");
    return crudMessage;
}